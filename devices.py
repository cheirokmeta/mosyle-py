...
def main():
    # argparse definition
    parser = argparse.ArgumentParser(description='## Mosyle API wrapper',
                                     prog='mosyle',
                                     usage='%(prog)s [options] device')
    # command argument definition
    parser.add_argument('--command', help='command to send to target device',
                        type=str, required=True)
    # device argument definition
    parser.add_argument('--device', help='target device', type=str,
                        required=True)
